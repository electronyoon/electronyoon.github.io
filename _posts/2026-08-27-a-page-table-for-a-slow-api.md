...
- mean 87.4% (1,458ms → 184ms)
- median 90.2% (1,450ms → 142ms)
- P95 89.3% (4,826ms → 515ms)
- P99 81.4% (7,637ms → 1,418ms)

It improved. <span style="opacity:0.45;">(one day, 2026.09.02)</span>
...
- P23 through P91 did not deviate far from the prediction, within ±5% error.
- The P92-and-up latency was due to transactions using the dbizNm (program name) parameter. That is not a target of this change.

<canvas id="chart-pct-lofin-combo"></canvas>

| Metric | Before | After, 1 day | <span style="opacity:0.45;">1 week</span> | <span style="opacity:0.45;">2 weeks</span> | <span style="opacity:0.45;">1 month</span> |
|:---:|:---:|:---:|:---:|:---:|:---:|
| mean | 1,458ms | 184ms (▼87.4%) | | | |
| median | 1,450ms | 142ms (▼90.2%) | | | |
| P95 | 4,826ms | 515ms (▼89.3%) | | | |
| P99 | 7,637ms | 1,418ms (▼81.4%) | | | |

- before, 1 month, 2026.08.01 to 2026.08.31, about 790,000 transactions
- after, 1 day, 2026.09.02, about 27,000 transactions
<div style="opacity:0.45;" markdown="1">
- after, 1 week, 2026.09.02 to 2026.09.08, about - (pending)
